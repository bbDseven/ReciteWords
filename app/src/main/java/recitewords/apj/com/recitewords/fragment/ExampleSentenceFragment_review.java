...
public class ExampleSentenceFragment_review extends BaseFragment implements ReviewActivity.OnmToggleListener {
    ...
    public void initData() {
        ...
        //监听例句是否显示，显示自动播放例句
        ReviewActivity reviewActivity = (ReviewActivity) mActivity;
        reviewActivity.setmOnToggleListener(this);
