...
public class WordReviewDao {
     ...
     * @param complete           20个单词中，已经复习的单词个数
     * @param date               日期
    ...
    public long addWord(String word, String option_A, String option_B, String option_C, String option_D,
                        ...
                        String answer_user,int complete, String date, String book_name, int userID) {
    ...
    public List<WordReview> queryAll(String book_name) {
        ...
        while (cursor.moveToNext()) {
            ...
            wordReview.setComplete(cursor.getInt(cursor.getColumnIndex("complete")));
    ...
    public long updateWordDate(String date, String word, String book_name) {
        ...
        SQLiteDatabase db = helper.getWritableDatabase();
        int num = db.update("word_review", mValues, "word=?,book_name=?", new String[]{word, book_name});
        mValues.clear();
        db.close();
        return num;
    }
