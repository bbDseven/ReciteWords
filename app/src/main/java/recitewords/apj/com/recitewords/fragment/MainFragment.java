...
public class MainFragment extends BaseFragment implements View.OnClickListener {
    ...
    * */
    private void insertBook() {
        ...
        bookDao.addWord("murder","[ˈmɜ:rdə(r)]","[ˈmɜ:də(r)]","n.谋杀;杀戮;极艰难[令人沮丧]的经历 vt.凶杀;糟蹋;打垮 vi.杀人",0,0,"CET4",0);
        bookDao.addWord("progress","[ˈprɑ:gres]","[ˈprəʊgres]","n.进步;前进;[生物学]进化;（向更高方向）增长 v.发展;（使）进步，（使）进行;促进 vi.发展;（向更高方向）增进",0,0,"CET4",0);
        bookDao.addWord("religious","[rɪˈlɪdʒəs]","[rɪˈlɪdʒəs]","adj.宗教的;虔诚的;笃信宗教的;谨慎的 n.修士，修女，出家人",0,0,"CET4",0);
        bookDao.addWord("smart","[smɑ:rt]","[smɑ:t]","adj.聪明的;敏捷的;漂亮的;整齐的 vi.疼痛;感到刺痛;难过 n.创伤;刺痛;疼痛;痛苦 vt.引起…的疼痛（或痛苦、苦恼等） adv.聪明伶俐地，轻快地，漂亮地",0,0,"CET4",0);
        bookDao.addWord("barber","[ˈbɑ:rbə(r)]","[ˈbɑ:bə(r)]","n.理发师;理发店(= barber's shop) vt.为…理发剃须;修整 vi.当理发师;给人理发",0,0,"CET4",0);
        bookDao.addWord("animal","[ˈænəməl]","[ˈænɪml]","n.动物，兽，牲畜;<俚>家畜，牲口;<俚>畜生（一般的人）;兽性 adj.动物的;肉体的;肉欲的",0,0,"CET4",0);
        bookDao.addWord("abandon","[əˈbændən]","[əˈbændən]","vt.放弃，抛弃;离弃，丢弃;使屈从;停止进行，终止 n.放任，放纵;完全屈从于压制",0,0,"CET4",0);
        ...
        bookDao.addWord("aboard","[əˈbɔ:rd]","[əˈbɔ:d]","prep.上车;在（船、飞机、车）上，上（船、飞机、车） adv.在船（或飞机、车）上，上船（或飞机、车）;靠船边;在船上;在火车上",0,0,"CET4",0);
        bookDao.addWord("about","[əˈbaʊt]","[əˈbaʊt]","prep.关于;大约;在…周围 adv.大约;在附近;在四周;几乎 adj.在附近的;四处走动的;在起作用的;在流行中的",0,0,"CET4",0);
        bookDao.addWord("abroad","[əˈbrɔd]","[əˈbrɔ:d]","adv.到国外，在海外;广为流传地 adj.往国外的 n.海外，异国",0,0,"CET4",0);
        ...
        bookDao.addWord("anniversary","[ˌænɪˈvɜ:rsəri]","[ˌænɪˈvɜ:səri]","n.周年纪念日 adj.周年的;周年纪念的;年年的;每年的",0,0,"CET4",0);
        bookDao.addWord("announce","[əˈnaʊns]","[əˈnaʊns]","vi.宣布参加竞选;当播音员 vt.宣布;述说;声称;预告",0,0,"CET4",0);
        bookDao.addWord("bankrupt","[ˈbæŋkˌrʌpt, -rəpt]","[ˈbæŋkrʌpt]","adj.破产的，倒闭的;完全缺乏的;（名誉）扫地的，（智力等）完全丧失的;垮了的，枯竭的 n.破产者;无力偿还债务者;丧失（名誉，智力等）的人  vt.使破产，使枯竭，使极端贫困",0,0,"CET4",0);
