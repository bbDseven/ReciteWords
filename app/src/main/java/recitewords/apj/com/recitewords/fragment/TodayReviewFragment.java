...
public class TodayReviewFragment extends BaseFragment {
    ...
    public View initView() {
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.fragment_today_review, null);
        holder.today_rv_review=findViewByIds(view,R.id.today_rv_review);
        return view;
    }
